...
$(document).ready(function(){
    $('#myTable').dataTable({
        "sAjaxSource": "http://www.chesteraustin.us/cfc/entry.cfc?ReturnFormat=json&method=testEntry",
//        "sAjaxSource": "../cfc/entry.cfc?method=testEntry",
        "aoColumns": [
            {"mDataProp": "ID", "sTitle": "Set Number"},
            {"mDataProp": "NAME", "sTitle": "Set Name"}
        ]
    });
});